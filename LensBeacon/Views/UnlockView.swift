            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    VStack(spacing: 0) {
                        ...
                        Divider()
                        feature("Watch complication", "The same count on your wrist — relayed from your iPhone, never a second scan.")
                        Divider()
                        feature("New-flag alerts", "An optional local notification when a likely or strong flag appears.")
                        Divider()
                        feature("Quiet hours", "Mute those alerts on a schedule. By time only, never by place.")
                        Divider()
                        feature("Unlimited history", "Keep every sighting instead of the last 7 days.")
                        Divider()
                        feature("CSV export and session reports", "Take your log with you, or share a plain-language summary of what you saw.")
                    }
